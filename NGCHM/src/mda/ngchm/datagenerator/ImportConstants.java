...
public final class ImportConstants {
  ...
  public static Set<String> NA_VALUES = new HashSet<String>(
    Arrays.asList("null", "NA", "N/A", "-", "?", "NAN", "NaN", "Na", "na", "n/a", EMPTY, SPACE)
  );
  ...
  public static Set<String> NGCHM_FILES = new HashSet<String>(
    Arrays.asList("mapConfig.json", "mapData.json", "tn.png", "tnPre.png")
  );
