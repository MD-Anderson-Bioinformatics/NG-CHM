	...
	*/
	var toJSON = function(node, opts, depth) {
		...
		if (node.nodeType === 1) {
			...
			/* Stub of a new feature: only keep nodes with the following class names.
			   TODO: clean this up to fit in with the API (i.e. allow user to supply list of
			         class names to keep) and create a pull request
			*/
