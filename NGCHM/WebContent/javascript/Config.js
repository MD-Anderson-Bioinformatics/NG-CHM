(function () {
  ...
  NgChm.createNS("NgChm.CFG", {
    ...
    //
    custom_script: document.body.dataset.hasOwnProperty("ngchmCustomFile")
      ? document.body.dataset.ngchmCustomFile
      : "javascript/custom/custom.js",

    // Location of default NG-CHM GUI builder.
    //
    builder_url: document.body.dataset.hasOwnProperty("ngchmBuilderUrl")
      ? document.body.dataset.ngchmBuilderUrl
      : defaultBuilderURL,
  });
})();
