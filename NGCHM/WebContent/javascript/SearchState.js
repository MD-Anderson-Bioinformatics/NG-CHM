(function() {
	...
	const labels = axis == 'Row' ? heatMap.getRowLabels()["labels"] :
	               axis == "Column" ? heatMap.getColLabels()['labels'] :
		       axis == "ColumnCovar" ? Object.keys(heatMap.getColClassificationConfig()) :
		       axis == "RowCovar" ? Object.keys(heatMap.getRowClassificationConfig()) : 
